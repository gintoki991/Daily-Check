        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="border border-slate-300 px-2 py-2 flex items-center justify-center">
                    ...
                    @else
                    <!-- 編集ボタン（濃いグレー） -->
                    <button wire:click="edit({{ $site->id }})" type="button" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-gray-900 text-gray-500 hover:bg-gray-700 hover:outline-blue-500 focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 cursor-pointer">
                        編集
                    </button>
                    @endif
